...
def main():
    """
    Main function to train and evaluate a Decision Tree classifier for IDS.
    ...
    """
    # Define paths
    print("Starting Decision Tree IDS model training...")
    ...
    # Set up hyperparameter grid for Decision Tree
    param_grid = {
    ...
    y_prob = best_dt.predict_proba(X_test)[:, 1]  # Probability for the positive class
    ...
    results_path = os.path.join(results_dir, "DT.csv")
